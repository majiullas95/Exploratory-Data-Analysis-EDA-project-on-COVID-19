# Exploratory-Data-Analysis-EDA-project-on-COVID-19
Column               	Notes
Company     	      Car brand
Model, Variant	 Car model details
FuelType	       Petrol / Diesel / CNG
Kilometer	        Distance driven
TransmissionType	Manual / Automatic (has missing values)
ModelYear	         Manufacturing year
Owner	            "1st Owner", "2nd Owner"
Price	             Target (e.g. 5.75 Lakhs)
City, DealerState	   Location
Warranty           	Binary
